        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.body}>
                <View style={styles.menu}>
                    <Button title='Cadastrar Curso' icon={2} onPress={() => navigation.navigate('RegisterCourse' as never)}/>
                </View>
                <View style={styles.menu}>
                    <Button title='Lista de Cursos' icon={3} onPress={() => navigation.navigate('ListCourses' as never)}/>
                </View>
            </View>
        </SafeAreaView>
    )
